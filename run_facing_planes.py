#!/usr/bin/env python3
"""
Run the correctly facing plane visualization.
"""
...
# Load the correctly facing plane visualization model
viz_path = os.path.join(os.path.dirname(__file__), 'ezgripper_facing_planes.xml')
...
try:
    ...
    print("="*60)
    print("CORRECTLY FACING PLANE VISUALIZATION")
    print("="*60)
    ...
    try:
        ...
        with mujoco.viewer.launch_passive(model, data) as viewer:
            ...
            print("✓ 3D Viewer launched with correctly facing planes!")
            ...
            print("\n🎬 Starting correctly facing plane overlap demonstration...")
    ...
    if not viewer_launched:
        ...
        print("The XML file contains correctly facing 2D planes for use with any MuJoCo viewer.")
...
print("\n" + "="*60)
print("CORRECTLY FACING PLANE VISUALIZATION COMPLETE")
print("="*60)
print("\n🎯 The correctly facing 2D planes now show:")
print("  ✅ Planes are oriented to face each other")
