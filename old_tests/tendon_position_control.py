...
try:
    ...
    print("🎯 Tendon position control simulation")
...
print("\n" + "=" * 60)
print("TENDON POSITION CONTROL - FINGERS TOUCHING")
print("=" * 60)
...
while viewer.is_running() and step < max_steps:
    ...
    # Start at current length, gradually shorten to close
    if step < 500:
        # Phase 1: Gradually close
        progress = step / 500.0
        # Shorten tendon from 0.168m to 0.140m
        target_length = 0.168 - progress * 0.028
    elif step < 1000:
        ...
        target_length = 0.140 + progress * 0.015
    else:
        # Phase 4: Re-close
        progress = (step - 1500) / 500.0
        target_length = 0.155 - progress * 0.015
    
    # Set tendon position control with high gain
...
print("\n🎬 Tendon position control simulation complete!")
print("=" * 60)
