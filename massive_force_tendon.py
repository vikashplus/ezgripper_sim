...
try:
    ...
    print("🎯 HIGH FORCE tendon actuation")
    print("👀 Watch fingers close and touch with massive tendon force")
except Exception as e:
    print(f"❌ Could not launch viewer: {e}")
    exit(1)

print("\n" + "=" * 60)
print("HIGH FORCE TENDON ACTUATION - FINGERS TOUCHING")
print("=" * 60)
...
print("Applying MASSIVE tendon force to overcome springs...")
...
# Simulation: apply massive force
step = 0
max_force = 1000.0  # MASSIVE force - 10x previous!
ramp_time = 200    # Quick ramp up
hold_time = 800    # Hold for longer
...
while viewer.is_running() and step < 1500:
    ...
    # Apply MASSIVE tendon forces to both fingers
    ...
    if step % 100 == 0:
        ...
        print(f"  Tendon force: {force:.1f}N (MASSIVE!)")
        ...
        if finger_contacts > 0:
            ...
            print(f"  ⚠️  Fingers not touching yet - force may still be too low!")
    
    # Sync viewer
    viewer.sync()
    step += 1

print("\n🎬 High force tendon actuation complete!")
print("=" * 60)
