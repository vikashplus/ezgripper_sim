...
print("=" * 60)
print("EZGripper - Fully Open Position")
print("=" * 60)

# Command fully open (maximum tendon length)
open_length = 0.160  # meters
data.ctrl[gripper_f1_id] = open_length
data.ctrl[gripper_f2_id] = open_length

print(f"Commanding tendon length: {open_length:.4f} m (fully open)")
print("\nLaunching viewer...")
