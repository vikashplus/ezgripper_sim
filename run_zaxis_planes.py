#!/usr/bin/env python3
"""
Run the Z-axis parallel plane visualization.
"""
...
# Load the Z-axis parallel plane visualization model
viz_path = os.path.join(os.path.dirname(__file__), 'ezgripper_zaxis_planes.xml')
...
try:
    ...
    print("="*60)
    print("Z-AXIS PARALLEL PLANE VISUALIZATION")
    print("="*60)
    print("\n🟦 BLUE planes: Palm stop planes (fixed, parallel to Z)")
    ...
    try:
        ...
        with mujoco.viewer.launch_passive(model, data) as viewer:
            ...
            print("✓ 3D Viewer launched with Z-axis parallel planes!")
            ...
            print("\n🎬 Starting Z-axis plane overlap demonstration...")
    ...
    if not viewer_launched:
        ...
        print("The XML file contains Z-axis parallel 2D planes for use with any MuJoCo viewer.")
...
print("\n" + "="*60)
print("Z-AXIS PARALLEL PLANE VISUALIZATION COMPLETE")
print("="*60)
print("\n🎯 The Z-axis parallel 2D planes now show:")
print("  ✅ Planes are parallel to Z axis (vertical)")
