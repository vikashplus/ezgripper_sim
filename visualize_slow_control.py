#!/usr/bin/env python3
"""
Visualize slow tendon control at 1mm/sec with damping=1.0.
"""
...
print("="*80)
print("SLOW TENDON CONTROL VISUALIZATION (1mm/sec, damping=1.0)")
print("="*80)
print("The gripper will automatically cycle through:")
print("  1. Open (0.150 -> 0.200) - 50 seconds")
print("  2. Close (0.200 -> 0.100) - 100 seconds") 
print("  3. Neutral (0.100 -> 0.150) - 50 seconds")
print("Total cycle: 200 seconds")
print("="*80)
...
phase_start_time = 0
phase_duration = [50, 100, 50]  # seconds for each phase
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        if phase_progress >= 1.0:
            ...
            phase_progress = 0.0
            print(f"\n[{data.time:6.1f}s] Starting phase {phase + 1}: "
        ...
        if int(data.time) % 5 == 0 and data.time - int(data.time) < model.opt.timestep:
