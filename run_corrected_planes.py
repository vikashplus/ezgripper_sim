...
try:
    ...
    try:
        ...
        with mujoco.viewer.launch_passive(model, data) as viewer:
            ...
            print("✓ 3D Viewer launched with corrected 2D planes!")
            ...
            print("\n🎬 Starting corrected plane overlap demonstration...")
...
print("="*60)
print("\n🎯 The corrected 2D planes now show:")
print("  ✅ Planes are perpendicular to finger movement")
